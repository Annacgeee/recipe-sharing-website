...
FOREIGN KEY (RecipeID) REFERENCES Recipe,
FOREIGN KEY (CategoryName) REFERENCES Beverage,
FOREIGN KEY (CategoryName) REFERENCES Dessert,
FOREIGN KEY (CategoryName) REFERENCES Cuisine,
FOREIGN KEY (CategoryName) REFERENCES EasyRecipe);
